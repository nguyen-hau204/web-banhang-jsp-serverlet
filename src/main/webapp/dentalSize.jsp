...
<form action="/suasize?id=${size.id}" method="post">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="ngaydat"  value="${size.ngayTao}">
    </div>
    <div class="mb-3">
        <label  class="form-label"> ngày sửa </label>
        <input type="text" class="form-control" name="ngaysua"  value="${size.ngaySua}">
    </div>
    <div class="mb-3">
